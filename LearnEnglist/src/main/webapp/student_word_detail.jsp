...
<link href="resource/bootstrap-3.3.7/dist/css/bootstrap.min.css" rel="stylesheet">
    ...
    <script type="text/javascript" src="js/word_list.js"></script>
    <!-- Custom styles for this template -->
    <link href="css/signin.css" rel="stylesheet">
    <script type="text/javascript" src="js/jquery-3.2.1.min.js"></script>
    <script type="text/javascript" src="js/student_word_detail.js"></script>
<!--//fonts-->
</head>
<body>
<!--Header-->
	<div class="header" id="home">
						...
						<nav class="navbar navbar-default">
							...
							<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
								...
								<ul>
									...
									<li><a href="update_student_level.jsp">修改等级</a></li>								</ul>
								</nav>
							</div>
		...
		<input id="wordName" name="wordName" style="width: 100px" type="text"
			placeholder="单词名称" />
		<input type="submit" class="btn btn-info btn-mini" value="查询"
			onclick="searchWord()"> -->
		
	<ul class="nav nav-pills" role="tablist">
		<li role="presentation" class="active"><h2>单词本   </h2></li>
		<li role="presentation" class="active"><a>第<span class="badge">
		<div class="centerDataCount">1</div>
		</span>个</a></li>
        <li role="presentation" class="active"><a>总数<span class="badge">
        	<div class="centerDataTotal">20</div>
        </span></a></li>
      </ul>
					<div class="bdata-infoitem-table centerData noheight">
					</div>
       <div class="mainlist_page"></div>
			<input type="hidden" id="currentpage" />
	<input type="hidden" id="totalpage" />
	<div class="isAddWord"></div>
    </div> <!-- /container -->
			<div class="copy">
