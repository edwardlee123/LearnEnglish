...
<link href="resource/bootstrap-3.3.7/dist/css/bootstrap.min.css" rel="stylesheet">
    ...
    <link href="css/signin.css" rel="stylesheet">
    <script type="text/javascript" src="js/jquery-3.2.1.min.js"></script>
     <script type="text/javascript" src="js/student_word_test.js"></script>
<!--//fonts-->
</head>
<body>
<!--Header-->
	<div class="header" id="home">
		<!--Top-Bar-->
						...
						<nav class="navbar navbar-default">
							...
							<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
								...
								<ul>
									...
									<li><a href="update_student_level.jsp">修改等级</a></li>
									<!-- <li><a href="#projects" class="scroll" data-hover="Projects">Projects</a></li>
			...
			<div class="container">
		<h2><span id="listaddress">单词</span><span id="listTitle">测试</span><span ></span></h2>
					<div class="bdata-infoitem-table centerData noheight">
					</div>
					<input id="wordName" name="wordName" style="width: 100px" type="text"
			placeholder="单词名称" />
		<input type="button" class="btn btn-info btn-mini" value="提交" id="searchButton"
			onclick="searchWord()">
       <div class="mainlist_page"></div>
			<input type="hidden" id="currentpage" />
	<input type="hidden" id="totalpage" />
    </div> <!-- /container -->
      <!-- <a href="" class="btn btn-lg btn-primary ">单词本</a> -->
		<!--//Top-Bar-->
			<div class="copy">
